...
public class MiddleScoreOneBalance extends AutoBase {
    ...
    public void init() {
        ...
        final Pose2d initialPose = createPose2dInches(0, getStartingYOffsetInches(
        ...
        final Pose2d driveOverPose = createPose2dInches(182, 0, 0);
        final Pose2d pickUpPose = createPose2dInches(252, -12, 0);
        ...
        ParallelDeadlineGroup pickUpGroup = new ParallelDeadlineGroup(
            pickupCommand,
            new ElevatorPositionCommand(ElevatorPosition.GROUND_PICKUP, elevator),
            new ArmOutCommand(arm).beforeStarting(new WaitCommand(0.25)),
